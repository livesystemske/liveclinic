...
using LiveAuth.Admin.Api.Configuration.ApplicationParts;
using LiveAuth.Admin.Api.Configuration.AuditLogging;
using LiveAuth.Admin.Api.Configuration.Constants;
using LiveAuth.Admin.Api.Helpers.Localization;
...
namespace LiveAuth.Admin.Api.Helpers
{
