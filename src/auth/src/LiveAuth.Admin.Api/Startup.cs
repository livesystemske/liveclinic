...
using LiveAuth.Admin.Api.Configuration;
using LiveAuth.Admin.Api.Configuration.Authorization;
using LiveAuth.Admin.Api.ExceptionHandling;
using LiveAuth.Admin.Api.Helpers;
using LiveAuth.Admin.Api.Mappers;
using LiveAuth.Admin.Api.Resources;
...
using LiveAuth.Admin.EntityFramework.Shared.DbContexts;
using LiveAuth.Admin.EntityFramework.Shared.Entities.Identity;
using Skoruba.Duende.IdentityServer.Shared.Configuration.Helpers;
using LiveAuth.Shared.Dtos;
using LiveAuth.Shared.Dtos.Identity;
using Microsoft.IdentityModel.Logging;

namespace LiveAuth.Admin.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            IdentityModelEventSource.ShowPII = Configuration.GetValue<bool>("Spi"); ;
