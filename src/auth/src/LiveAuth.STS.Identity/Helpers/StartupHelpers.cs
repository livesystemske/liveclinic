...
using LiveAuth.STS.Identity.Configuration;
using LiveAuth.STS.Identity.Configuration.ApplicationParts;
using LiveAuth.STS.Identity.Configuration.Constants;
using LiveAuth.STS.Identity.Configuration.Interfaces;
using LiveAuth.STS.Identity.Helpers.Localization;
using LiveAuth.STS.Identity.Services;
...
namespace LiveAuth.STS.Identity.Helpers
{
    public static class StartupHelpers
    {
        ...
        /// <typeparam name="TConfigurationDbContext"></typeparam>
        /// <typeparam name="TPersistedGrantDbContext"></typeparam>
        /// <typeparam name="TRoleIdentity"></typeparam>
        /// <param name="services"></param>
        /// <param name="configuration"></param>
            ...
            //where TRoleIdentity : class
        {
            ...
            // services
            //     .AddScoped<IUserClaimsPrincipalFactory<TUserIdentity>,
            //         UserClaimsPrincipalFactory<TUserIdentity, TRoleIdentity>>();
            
            services.AddScoped<IProfileService,LiveProfileService>();
